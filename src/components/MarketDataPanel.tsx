...
type IncidentCommandItem = {
  incident: string;
  severity: ExecutionHandoffPriority;
  status: ExecutionReviewStatus;
  trigger: string;
...
function incidentSlaLabel(status: ExecutionReviewStatus, priority: ExecutionHandoffPriority) {
...
function buildIncidentCommandItems({
  ...
  dataContractDecision: ExecutionReviewStatus;
  dataRemediationDecision: ExecutionReviewStatus;
  marketAlertDecision: ExecutionReviewStatus;
  apiServiceCatalogDecision: ExecutionReviewStatus;
  apiContractBlueprintDecision: ExecutionReviewStatus;
  ...
  const warehouseStatus: ExecutionReviewStatus = hasBigQueryCredentials ? dataPipelineDecision : "block";
...
function incidentCommandCsv(rows: IncidentCommandItem[]) {

...
import { BigQueryPortfolioDrawdownChart } from "./BigQueryPortfolioDrawdownChart";
...
import { BigQueryPortfolioRiskContributionPanel } from "./BigQueryPortfolioRiskContributionPanel";
...
import { BigQueryPortfolioWealthChart } from "./BigQueryPortfolioWealthChart";
...
const metricGroups: BigQueryPortfolioMetricGroup[] = [
  {
    title: "報酬與總風險",
...
const snapshotMetricCards: BigQueryPortfolioMetricCard[] = [
  { key: "cagr", label: "CAGR", kind: "percent" },
  { key: "annualVolatility", label: "年化波動", kind: "percent" },
  { key: "sharpe", label: "Sharpe", kind: "number" },
  { key: "maxDrawdown", label: "最大回撤", kind: "percent" },
    ...
    <section className="bg-slate-900 border border-slate-800 p-4 md:p-6 rounded-xl shadow-2xl space-y-5">
      ...
      {displayResult && (
        <div className="space-y-4">
          ...
          <BigQueryPortfolioRiskContributionPanel
            rows={riskContributionRows}
            formatMetric={formatMetric}
          />
          ...
          <BigQueryPortfolioDrawdownChart

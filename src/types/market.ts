...
export type ExecutionRouteWarehouseRecord = {
  workspace_id: string;
  actor_id: string;
  route_id: string;
  ...
  route_state: string;
  route_status: string;
  route_notional: number;
  ticket_amount: number;
  cash_impact: number;
  batch_gross_amount: number;
  batch_cash_impact: number;
  estimated_slippage_bps: number;
  estimated_commission_bps: number;
  estimated_route_cost: number;
  approval_decision: string;
  route_note: string | null;
};

export type ExecutionRouteWarehouseSyncPayload = {
  table: string;
  workspace_id: string;
  actor_id: string;
  portfolio_id: string;
  ...
  generated_at: string;
  record_count: number;
  records: ExecutionRouteWarehouseRecord[];
};

export type ExecutionRouteWarehouseSyncResponse = {
  generatedAt: string;
  status: "synced" | "partial_error" | string;
  table: string;
  receivedCount: number;
...
export type ExecutionRouteWarehouseLatestResponse = {
  generatedAt: string;
  status: "loaded" | "missing" | "schema_outdated" | string;
  table: string;
  workspaceId: string;
  ...
  routeCount: number;
  missingFields?: string[];
  routes: ExecutionRouteWarehouseRecord[];
};

export type ExecutionRouteEventWarehouseRecord = {
  workspace_id: string;
  actor_id: string;
  event_id: string;
  route_id: string;
...
export type ExecutionRouteEventWarehouseSyncPayload = {
  table: string;
  workspace_id: string;
  actor_id: string;
  portfolio_id: string;
  ...
  generated_at: string;
  record_count: number;
  records: ExecutionRouteEventWarehouseRecord[];
};

export type ExecutionRouteEventWarehouseSyncResponse = {
  generatedAt: string;
  status: "synced" | "partial_error" | string;
  table: string;
  receivedCount: number;
...
export type ExecutionRouteEventWarehouseLatestResponse = {
  generatedAt: string;
  status: "loaded" | "missing" | "schema_outdated" | string;
  table: string;
  workspaceId: string;
...
export type OperatingKriWarehouseRecord = {
  workspace_id: string;
  actor_id: string;
  kri_id: string;
  idempotency_key: string;
  ...
  total_unfilled_notional: number;
  block_count: number;
  watch_count: number;
  source: string;
};

export type OperatingKriWarehouseSyncPayload = {
  table: string;
  workspace_id: string;
  actor_id: string;
  portfolio_id: string;
  ...
  generated_at: string;
  record_count: number;
  records: OperatingKriWarehouseRecord[];
};

export type OperatingKriWarehouseSyncResponse = {
  generatedAt: string;
  status: "synced" | "partial_error" | string;
  table: string;
  receivedCount: number;
...
export type OperatingKriWarehouseLatestResponse = {
  generatedAt: string;
  status: "loaded" | "missing" | "schema_outdated" | string;
  table: string;
  workspaceId: string;
